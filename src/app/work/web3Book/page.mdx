import logo from '@/images/clients/web3book/bitcoin.png'
...
export const caseStudy = {
  ...
  title: 'Web3Book',
  description:
    'An open-source adventure book about the world of crypto. It does not teach you any development content, but you can learn everything about investment, security, and study materials here.',
  summary: [
