import logo from '@/images/clients/evmbook/eth-icon.png'
...
export const caseStudy = {
  ...
  title: 'EvmBook',
  description:
    'An open-source dev book that helps developers build high-quality Dapps on EVM-compatible public chains. It also assists developers in mastering Dapps development from scratch.',
  summary: [
