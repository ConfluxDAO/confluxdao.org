import logo from '@/images/clients/conflux-docs/conflux-logo.svg'
...
export const caseStudy = {
  ...
  title: 'Conflux Docs',
  description:
    'Official documentation released by Conflux. ConfluxDAO continuously enhances this documentation to help developers have a better development experience on Conflux.',
  summary: [
