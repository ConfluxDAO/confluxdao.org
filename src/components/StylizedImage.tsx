...
const shapes = [
  ...
  },
  {
    width: 210,
    height: 210,
    path: 'M192 125.036L134.581 67.0001L77 125.198L77.1836 152.4L134.337 94.6362L191.905 152.822L192 125.036Z M164.871 152.81L134.47 183.536L117.551 166.436L147.952 135.709L134.431 122.043L90.3623 166.583L134.31 211L178.378 166.46L164.871 152.81Z',
  },
  {
    width: 719,
    height: 680,
...
export function StylizedImage({
  ...
  return (
    <div
      className={clsx(
        className,
        'relative flex aspect-[719/680] w-full justify-center',
      )}
    >
      <svg viewBox={`0 0 ${width} ${height}`} fill="none" className="">
