...
export function Logomark({
  ...
  return (
    <svg viewBox="0 60 160 160" width="200" aria-hidden="true" {...props}>
      <rect
        clipPath={`url(#${id}-clip)`}
        className={clsx(
          'h-60 transition-all duration-300',
          invert ? 'fill-white' : 'fill-neutral-950',
          filled ? 'w-48' : 'w-0 group-hover/logo:w-8',
        )}
      />
      <use
        href={`#${id}-path`}
      ...
      <defs>
        <path
          id={`${id}-path`}
          fill="none"
          d="M164.871 152.81L134.47 183.536L117.551 166.436L147.952 135.709L134.431 122.043L90.3623 166.583L134.31 211L178.378 166.46L164.871 152.81Z M192 125.036L134.581 67.0001L77 125.198L77.1836 152.4L134.337 94.6362L191.905 152.822L192 125.036Z"
        />
        <clipPath id={`${id}-clip`}>
          <use href={`#${id}-path`} />
        </clipPath>
